...
Example xor1: xor' true true = false.
Proof. simpl. reflexivity. Qed.
...
Example xor2: xor'' true false = true.
Proof. simpl. reflexivity. Qed.
...
Theorem negation_fn_applied_twicec :
forall (f : bool -> bool),
...
match n with
| Ob => O
| S2n n1 => 2 * (bin_to_nat n1)
| S2n1 n1 =>  2 * (bin_to_nat n1) + 1
end.

Example test_bin_incr1: bin_to_nat Ob = 0.
Proof. simpl. reflexivity. Qed. 
Example test_bin_incr2: bin_to_nat (incr Ob) = 1.
Proof. simpl. reflexivity. Qed. 
Example test_bin_incr3: bin_to_nat  (incr (incr Ob)) = 2.
Proof. simpl. reflexivity. Qed. 
Example test_bin_incr4: bin_to_nat (incr (incr (incr Ob))) = 3.
Proof. simpl. reflexivity. Qed. 
Example test_bin_incr5: bin_to_nat (incr (incr (incr (incr Ob)))) = 4.
Proof. simpl. reflexivity. Qed. 
...
(** Fixpoint add_consecutive (n : nat) : nat :=
match n with
| O => 0
| 1 => 1
| S(S n1) => n + add_consecutive(S n1) + add_consecutive n1
end. *)
