...
Theorem emp: excluded_middle <-> peirce.
Proof.
...
Theorem emc: excluded_middle <-> classic.
Proof.
unfold excluded_middle.
unfold classic.
split.
...
Theorem emdm : excluded_middle <-> de_morgan_not_and_not.
Proof.
unfold excluded_middle.
...
Theorem emito : excluded_middle <-> implies_to_or.
Proof.
unfold excluded_middle.
